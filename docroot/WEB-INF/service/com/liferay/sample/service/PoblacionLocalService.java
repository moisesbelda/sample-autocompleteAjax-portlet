...
/**
 * Provides the local service interface for Poblacion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Moises Belda
 * @see PoblacionLocalServiceUtil
...
public interface PoblacionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PoblacionLocalServiceUtil} to access the poblacion local service. Add custom service methods to {@link com.liferay.sample.service.impl.PoblacionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
